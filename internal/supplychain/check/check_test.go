...
func TestDetectEcosystemFromPath(t *testing.T) {
	tests := []struct {
		...
		{"pom.xml", supplychain.EcosystemMaven},
		{"/app/pom.xml", supplychain.EcosystemMaven},
		{"gradle.lockfile", supplychain.EcosystemGradle},
		{"poetry.lock", supplychain.EcosystemPoetry},
		{"/project/poetry.lock", supplychain.EcosystemPoetry},
		...
		{"requirements-lock.txt", supplychain.EcosystemPip},
