...
Security fixes are provided for the latest released version of this CLI.
Users are encouraged to upgrade to the most recent version to receive
security updates.
...
Security issues related to cloud services should be reported through the
appropriate cloud security disclosure channel.
...
demonstrable security impact may be considered out of scope.
